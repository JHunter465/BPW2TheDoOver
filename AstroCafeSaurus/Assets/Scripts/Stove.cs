...
{
    [SerializeField] private List<string> Cookable = new List<string>();
    ...
    public void PlayerInteraction(GameObject item)
    {
        if (item != null)
        {
            foreach (string tag in Cookable)
            {
                if (tag == item.tag)
                {
    ...
    //private void FirstKeypress()
    //{
    //    Debug.LogError("1");
    //    if (FirstKeyRoutine != null) { StopCoroutine(FirstKeyRoutine); }
    //    FirstKeyRoutine = StartCoroutine(FirstKey());
    //}

    //IEnumerator FirstKey()
    //{

    //}
    //private void SecondKeyPress()
    //{
    //    Debug.LogError("13");
    //    bool notDone = true;
    //    while (notDone)
    ...
    //            ThirdKeyPress();
    //        }
    //        else if (!Input.GetButtonDown(theOrder[1]))
    //        {
    //            startCutting();
    //            UIManager.Instance.FailedCombo();
    //        }
    ...
    //            FourthKeyPress();
    //        }
    //        else if (!Input.GetButtonDown(theOrder[2]))
    //        {
    //            startCutting();
    //            UIManager.Instance.FailedCombo();
    //        }
    ...
    //            theFood.GetComponent<FoodItem>().changeState(2);
    //        }
    //        else if (!Input.GetButtonDown(theOrder[3]))
    //        {
    //            startCutting();
    //            UIManager.Instance.FailedCombo();
    //        }
